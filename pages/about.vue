  ...
  <main>
    <div class="relative h-full w-full pl-5 pt-20">
      <div class="absolute mt-[10rem] h-[8vw] w-[8vw] flex-col items-center">
        <a href="https://github.com/ebortsov" rel="noopener noreferrer" target="_blank" class="hover:text-green-500 transition duration-300 ease-in-out">
      ...
      <div class="absolute ml-[90rem] mt-[10rem] h-[8vw] w-[8vw] flex-col items-center">
        <a href="https://github.com/acecution" rel="noopener noreferrer" target="_blank" class="hover:text-green-500 transition duration-300 ease-in-out">
          <div class="app mb-[10px] h-[8vw] w-[8vw] rounded-full">
      ...
      <div class="absolute ml-[45rem] mt-[10rem] h-[8vw] w-[8vw] flex-col items-center">
        <a href="https://github.com/lanebo1" rel="noopener noreferrer" target="_blank" class="hover:text-green-500 transition duration-300 ease-in-out">
          <div class="app mb-[10px] h-[8vw] w-[8vw] rounded-full">
      ...
      <div class="absolute ml-[25rem] h-[8vw] w-[8vw] flex-col items-center">
        <a href="https://github.com/Pickpusha" rel="noopener noreferrer" target="_blank" class="hover:text-green-500 transition duration-300 ease-in-out">
          <div class="app mb-[10px] h-[8vw] w-[8vw] rounded-full">
      ...
      <div class="absolute ml-[65rem] h-[8vw] w-[8vw] flex-col items-center">
        <a href="https://github.com/newspec" rel="noopener noreferrer" target="_blank" class="hover:text-green-500 transition duration-300 ease-in-out">
          <div class="app mb-[10px] h-[8vw] w-[8vw] rounded-full">
      ...
      <div class="absolute ml-[25rem] mt-[25rem] h-[8vw] w-[8vw] flex-col items-center">
        <a href="https://github.com/projacktor" rel="noopener noreferrer" target="_blank" class="hover:text-green-500 transition duration-300 ease-in-out">
          <div class="app mb-[10px] h-[8vw] w-[8vw] rounded-full">
      ...
      <div class="absolute ml-[65rem] mt-[25rem] h-[8vw] w-[8vw] flex-col items-center">
        <a href="https://github.com/asqarslanov" rel="noopener noreferrer" target="_blank" class="hover:text-green-500 transition duration-300 ease-in-out">
          <div class="app mb-[10px] h-[8vw] w-[8vw] rounded-full">
      ...
      <div class="absolute ml-[45rem] mt-[35rem] h-[8vw] w-[8vw] flex-col items-center">
        <a href="https://github.com/1sarmatt" rel="noopener noreferrer" target="_blank" class="hover:text-green-500 transition duration-300 ease-in-out">
          <div class="app mb-[10px] h-[8vw] w-[8vw] rounded-full">
