...
const teamMembers = [
  {
    image: avatar1,
    alt: 'evgenii-photo',
    link: 'https://github.com/ebortsov',
    name: 'Evgenii Bortsov',
    role: 'UX/UI Designer'
  },
  {
    image: avatar2,
    alt: 'anastasia-photo',
    link: 'https://github.com/acecution',
    name: 'Anastasia Varfolomeeva',
    role: 'Front-end'
  },
  {
    image: avatar3,
    alt: 'kirill-photo',
    link: 'https://github.com/lanebo1',
    name: 'Kirill Efimovich',
    role: 'Algorithm Developer'
  },
  {
    image: avatar4,
    alt: 'ilya-linh-sdr-photo',
    link: 'https://github.com/Pickpusha',
  ...
  },
  {
    image: avatar6,
    alt: 'arsen-photo',
    link: 'https://github.com/projacktor',
    name: 'Arsen Galiev',
    role: 'Full-stack'
  },
  {
    image: avatar7,
    alt: 'asqar-photo',
    link: 'https://github.com/asqarslanov',
    name: 'Asqar Arslanov',
    role: 'Full-stack'
  },
  {
    image: avatar8,
    alt: 'sarmat-photo',
    link: 'https://github.com/1sarmatt',
...
<template>
  ...
  <main class="grid grid-cols-2 tablet:gap-40 desktop:gap-5">
    ...
    <div class="flex flex-col items-center space-y-8 tablet:pt-28">
      <Member
